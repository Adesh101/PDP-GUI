...
public interface IDollarCostAveraging {
   ...
   * @param commissionFee commission fee per transaction
   */
  void strategyForNewPortfolioWithEndDate(String portfolioName, List<String> stockNames, double amount,
      List<String> proportions, String startDate, String endDate, int interval, List<String> commissionFee);
   ...
   * @param commissionFee commission fee per transaction
   */
  void strategyForNewPortfolioWithoutEndDate(String portfolioName, List<String> stockNames, double amount, List<String> proportions, String startDate, int interval, List<String> commissionFee);
